...
initial_announcements = [
    {
        "_id": "welcome-enrollment-window",
        "title": "Janela de inscricoes aberta",
        "message": "As inscricoes para atividades estao abertas ate o fim do mes. Garanta a vaga dos estudantes com antecedencia.",
        "start_date": None,
